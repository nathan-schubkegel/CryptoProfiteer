...
namespace CryptoProfiteer
{
  ...
  public class PersistedTaxAssociation
  {
    ...
    public PersistedTaxAssociation Clone() =>
      new PersistedTaxAssociation { SaleOrderId = SaleOrderId, Purchases = Purchases.Select(x => x.Clone()).ToList() };
  }
  ...
  public class PersistedTaxAssociation_v04
  {
    ...
    public PersistedTaxAssociation_v04 Clone() =>
      new PersistedTaxAssociation_v04
      {
        Id = Id,
    ...
    public PersistedTaxAssociation ToLatest() =>
      new PersistedTaxAssociation
      {
        SaleOrderId = SaleOrderId,
